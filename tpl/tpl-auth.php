		...
		<div class="panel">
			<div class="auth-form on" id="login">
				...
				<form action="<?= siteUrl("auth.php?action=login") ?>" method="POST">
					<input name="email" type="emil" required="required" placeholder="email"/>
...
<!-- partial -->
<!-- jquery code for switching between two forms in js folder -->
  <script src='https://code.jquery.com/jquery-3.3.1.min.js'></script><script  src="assets/js/authscript.js"></script> 
